                ...
                <form class="col s12" method="post" action="">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            <?php
                            $id_surat = $_REQUEST['id_surat'];
                            $query2 = mysqli_query($config, "SELECT * FROM tbl_surat_masuk WHERE id_surat='$id_surat'");
                            while ($rw = mysqli_fetch_array($query2)) {
                                        
                            ?>
                            <input id="tujuan" type="text" class="validate" name="tujuan" value="<?php echo $rw['indeks']  ?>" readonly>
                                <?php } ?>
