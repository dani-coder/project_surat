                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            ...
                            <div class="input-field col s11 right">
                                <?php
                                    $sifatcek = mysqli_query($config, "SELECT * FROM tbl_sifat");
                                ?>
                                <select class="browser-default validate" name="kode" id="kode" required>
                                    <?php 
                                        while ($cdr = mysqli_fetch_array($sifatcek)) {
                                         ?>
                                    <option style="color: <?php echo $cdr['color_code']?>"><?php echo $cdr['sifat_nama']?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <?php
                        ...
                        <div class="input-field col s6">
                         <i class="material-icons prefix md-prefix">storage</i>
                            <div class="input-field col s11 right">
                             <?php
                                    $ktgcek = mysqli_query($config, "SELECT * FROM tbl_kategori");
                                ?>
                                <select class="browser-default validate" name="indeks" id="indeks" required>
                                    <option>Pilih kategori surat</option>
                                    <?php 
                                        while ($cdr2 = mysqli_fetch_array($ktgcek)) {
                                         ?>
                                    <option><?php echo $cdr2['ktg_nama']?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <?php
                            ...
                            ?>
                            <label for="indeks">Kategori Surat</label>
                        </div>
                        ...
                        <div class="input-field col s6">
                            ...
                            <textarea id="isi" class="materialize-textarea validate" name="isi" required></textarea>
                                ...
                                ?>
                            <label for="isi">Isi Ringkas Surat</label>
                        </div>
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="keterangan" type="text" class="validate" name="keterangan" required>
                                ...
                                ?>
                            <label for="keterangan">Validasi isi Kategori Surat</label>
                        </div>
