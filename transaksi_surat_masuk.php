                ...
                <?php
                    ...
                    $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                        ...
                        <table class="bordered" id="tbl">
                            ...
                            $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk WHERE kode LIKE '%$cari%' ORDER by id_surat ASC LIMIT 15");
                    ...
                    <!-- Row form END -->';
                        ...
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
                                ...
                                $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk ORDER by id_surat ASC LIMIT $curr, $limit");
                                if(mysqli_num_rows($query) > 0){
                                    $no = 1;
                                    while($row = mysqli_fetch_array($query)){
                                      echo '
                                      <tr>
                                        ...
                                        <td>'.indoDate($row['tgl_surat']).'</td>
                                        <td>'.$row['asal_surat'].'</td>
                                        <td style="color: red;">'.$row['kode'].'</td>
                                        <td>'.$row['indeks'].'</td>
                                        <td>'.$row['isi'].'</td>
