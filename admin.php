                    ...
                    <div class="card-content">
                        ...
                        <?php
                            if($_SESSION['admin'] == 1){
                                ...
                                echo "<strong>Raja/Ratu</strong>. Anda memiliki akses preview transaksi, berikut adalah statistik data yang tersimpan dalam sistem.";
                            } else {
                                echo "<strong>Petugas transaksi surat (masuk-keluar)</strong>. Berikut adalah statistik data yang tersimpan dalam sistem.";
                            }?></p>
                    </div>
                </div>
            </div>
