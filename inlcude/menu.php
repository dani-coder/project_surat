    ...
    <div class="nav-wrapper">
        ...
        <ul id="slide-out" class="side-nav" data-simplebar-direction="vertical">
                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                ...
                                echo '<h5 class="smk-side">Kesekretariatan Puro Pakualaman</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Jl. Masjid No.46, Gunungketur, Pakualaman, Kota Yogyakarta, Daerah Istimewa Yogyakarta 55166</p>';
                            }
                        }
                    ?>
                </div>
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    <li>
                        <a class="collapsible-header"><i class="material-icons">assignment</i> Arsip Surat</a>
                        <div class="collapsible-body">
                            <ul>
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">mail</i>AMS</a></li>
            <li><div class="grs"></></li>
            ...
            ?>
          <li><a class="dropdown-button" href="#!" data-activates="agenda">Arip Surat <i class="material-icons md-18">arrow_drop_down</i></a></li>
