                    ...
                    <div class="card blue-grey white-text">
                        <div class="card-content">';
                            ...
                            if(!empty($data['nama'])){
                                ...
                                echo '<h5 class="ins">Kesekretariatan Puro Pakualaman</h5>';
                            }

                            if(!empty($data['alamat'])){
                                echo '<p class="almt">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="almt">Jl. Masjid No.46, Gunungketur, Pakualaman, Kota Yogyakarta, Daerah Istimewa Yogyakarta 55166</p>';
                            }
                            echo '
                        </div>
                    </div>
