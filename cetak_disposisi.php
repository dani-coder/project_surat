            ...
            <div id="colres">
                <div class="disp">';
                    ...
                    list($institusi, $nama, $status, $alamat, $logo) = mysqli_fetch_array($query2);
                        ...
                        echo '<span id="alamat">Jl. Masjid No.46, Gunungketur, Pakualaman, Kota Yogyakarta, Daerah Istimewa Yogyakarta 55166</span>';
                ...
                echo '
                    <table class="bordered" id="tbl">
                        <tbody>
                            ...
                            <tr>
                                <td id="right" width="18%"><strong>Kategori Surat</strong></td>
                                <td id="left" style="border-right: none;" width="57%">: '.$row['indeks'].'</td>
                                <td id="left" width="25"><strong>Sifat Surat</strong> : '.$row['kode'].'</td>
                            </tr>
